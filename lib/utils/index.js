...
const RESERVED_TAG_NAMES = new Set(require("./reserved-tag-names.json"))
...
module.exports = {
    ...
    /**
     * Check whether the given name is a reserved tag name or not.
     * @param {string} name The name to check.
     * @returns {boolean} `true` if the name is a reserved tag name.
     */
    isReservedTagName(name) {
        console.assert(typeof name === "string")

        return RESERVED_TAG_NAMES.has(name.toLowerCase())
    },
    ...
    isCustomComponent(node) {
        ...
        return (
            !this.isReservedTagName(node.id.name) ||
